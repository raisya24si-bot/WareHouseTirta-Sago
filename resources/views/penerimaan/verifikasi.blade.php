                ...
                <div class="flex flex-col">
                    ...
                    <span class="font-body-sm text-[13px] text-on-tertiary-fixed-variant">
                        @if($totalRusak > 0)
                            ...
                            untuk supplier {{ $penerimaan->po?->supplier?->nm_master_supplier ?? '-' }}.
                        @else
                            ...
                            >
                                ...
                                <td class="py-stack-md px-stack-md text-right align-top">
                                    ...
                                    <div class="text-[10px] text-outline mt-1">
                                        per {{ $barang?->satuan?->nm_satuan ?? $barang?->satuan?->nama_satuan ?? 'unit' }}
                                    </div>
                                ...
                                <td class="py-stack-md px-stack-md align-top">
                                    ...
                                    <div class="flex flex-col gap-2 min-w-[220px]">
                                        ...
                                        @if($qtyBaik > 0)
                                            ...
                                            {{-- Value asli yang dikirim ke server; diisi oleh drawer alokasi. --}}
                                            <select
                                    ...
                                    <div class="flex flex-col items-center gap-2">
                                        ...
                                        @if($qtyBaik > 0)
                                            ...
                                            >
                                                ...
                                                {{ $selectedLokasi ? 'Ubah Bin' : 'Pilih Lokasi Bin' }}
                                            </button>
