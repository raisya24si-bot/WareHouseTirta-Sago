    ...
    <nav class="flex-1 overflow-y-auto px-2 space-y-5 custom-scrollbar">
        ...
        <div>
            ...
            <div class="mx-2">
                ...
                <div
                    ...
                    <a href="{{ route('master-kategori-gudang.index') }}"
                    class="{{ request()->routeIs('master-kategori-gudang.*')
                            ? 'bg-primary text-on-primary shadow-sm shadow-primary/30'
                            : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-low' }}
                            flex items-center px-4 py-2.5 rounded-lg transition-all duration-150">

                        <span class="material-symbols-outlined mr-3 text-[19px]" @if(request()->routeIs('master-kategori-gudang.*')) style="font-variation-settings: 'FILL' 1;" @endif>
                            category
                        </span>
        ...
        <div>
            ...
            <div class="space-y-0.5">
                ...
                <a
                    href="{{ route('permintaan-barang.index') }}"
                    class="{{ request()->routeIs('permintaan-barang.*')
                        ? 'bg-primary text-on-primary shadow-sm shadow-primary/30'
                        : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-low' }}
                        mx-2 flex items-center px-4 py-2.5 rounded-xl transition-all duration-150 group {{ request()->routeIs('permintaan-barang.*') ? '' : 'hover:pl-5' }}"
                >
                    <span class="material-symbols-outlined mr-3 text-[20px] {{ request()->routeIs('permintaan-barang.*') ? '' : 'text-outline group-hover:text-primary transition-colors' }}" @if(request()->routeIs('permintaan-barang.*')) style="font-variation-settings: 'FILL' 1;" @endif>
                        assignment
                    </span>
