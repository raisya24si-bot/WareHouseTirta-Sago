{{--
    ==========================================================================
    MODAL: TERIMA BARANG DARI PO
    ==========================================================================
    Ini masih TAMPILAN DUMMY:
    - Daftar PO di <select> & tabel item per-PO ($dummyPoOptions) di bawah
      ini contoh statis, ganti dengan PO APPROVED asli dari controller.
    - <form> belum action ke route beneran (belum dikasih method="POST"
      action=""), tinggal disambungkan pas backend-nya udah siap.
    - JS di bawah cuma buat preview: pas ganti PO di dropdown, baris
      item ikut berubah sesuai data dummy per-PO.
    ==========================================================================
--}}
@php
    $dummyPoOptions = [
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($dummyPoOptions as $kdPo => $po)
                            <option value="{{ $kdPo }}">{{ $kdPo }} &mdash; {{ $po['supplier'] }}</option>
                        @endforeach
                    </select>
                </div>
...
<script>
    ...
    const PENERIMAAN_DUMMY_PO = @json($dummyPoOptions);
