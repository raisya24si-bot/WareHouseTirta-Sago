...
>
    ...
    <div class="relative w-full max-w-2xl rounded-xl bg-white shadow-2xl">
        ...
        <form
            id="gudang-form"
            method="POST"
            action="<?php echo e(route('master-gudang.store')); ?>"
            class="space-y-4 p-6"
        >
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                >
                    ...
                    <?php $__currentLoopData = $kategoriGudangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
                            value="<?php echo e($kategori->id_kategori_gudang); ?>"
                        >
                            <?php echo e($kategori->nm_kategori_gudang); ?>
            ...
            <div>
                ...
                >
                    <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
                            value="<?php echo e($s->id_status_gudang); ?>"
                        >
                            <?php echo e($s->nm_status_gudang); ?>
...
function openGudangModal() {
    ...
    document.getElementById('gudang-form').action =
        '<?php echo e(route('master-gudang.store')); ?>';
...
function editGudang(
    ...
    document.getElementById('gudang-form').action =
        '<?php echo e(url('/master-gudang')); ?>/' + id;
...
</script><?php /**PATH D:\ProjectPDAM\laragon-6.0-minimal\www\MasterData_FULL_FIXED\MasterData\resources\views/components/master/gudang/gudang-modal.blade.php ENDPATH**/ ?>