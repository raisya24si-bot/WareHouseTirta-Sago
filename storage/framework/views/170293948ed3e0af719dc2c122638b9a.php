<aside
    ...
    <nav class="flex-1 overflow-y-auto px-2 space-y-1 custom-scrollbar">
        ...
        <div class="mx-2 my-1">
            ...
            <div
                ...
                class="<?php echo e(request()->routeIs('master-gudang.*') ? 'bg-primary text-on-primary' : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-low'); ?> flex items-center px-4 py-2.5 rounded-lg transition-colors">
        ...
        class="<?php echo e(request()->routeIs('opname.*')
            ...
            <span class="material-symbols-outlined mr-3 <?php echo e(request()->routeIs('opname.*') ? '' : 'text-outline group-hover:text-primary'); ?>">
                fact_check
            </span>
    ...
    <span class="material-symbols-outlined mr-3 <?php echo e(request()->routeIs('manajemen-stok.*') ? '' : 'text-outline group-hover:text-primary'); ?>">
        inventory
    </span>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const masterRoutes = [
                <?php echo json_encode(request()->routeIs('barang.*'), 15, 512) ?>,
                <?php echo json_encode(request()->routeIs('master-supplier.*'), 15, 512) ?>,
                <?php echo json_encode(request()->routeIs('master-kategori.*'), 15, 512) ?>,
                <?php echo json_encode(request()->routeIs('master-satuan.*'), 15, 512) ?>,
                <?php echo json_encode(request()->routeIs('master-gudang.*'), 15, 512) ?>,
            ];
...
<?php /**PATH D:\ProjectPDAM\laragon-6.0-minimal\www\MasterData\resources\views/components/layout/sidebar.blade.php ENDPATH**/ ?>