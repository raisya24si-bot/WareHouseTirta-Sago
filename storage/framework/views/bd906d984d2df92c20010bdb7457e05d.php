...
<?php $stockClass=match($barang->stok_status){'HABIS'=>'bg-red-100 text-red-700','MENIPIS'=>'bg-amber-100 text-amber-700',default=>'bg-green-100 text-green-700'}; ?>
<tr class="hover:bg-surface-container-low/50"><td class="px-4 py-3"><?php echo e($barang->kd_master_barang); ?></td><td class="px-4 py-3"><?php echo e($barang->nm_master_barang); ?></td><td class="px-4 py-3 text-on-surface-variant"><?php echo e($barang->kategori?->nm_master_kategori ?? '-'); ?></td><td class="px-4 py-3 text-on-surface-variant"><?php echo e($barang->satuan?->nm_master_satuan ?? '-'); ?></td><td class="px-4 py-3"><?php echo e(number_format($barang->stok_saat_ini)); ?></td><td class="px-4 py-3"><?php echo e(number_format($barang->minimum_stok)); ?></td><td class="px-4 py-3"><span class="rounded-full px-2.5 py-1 text-xs <?php echo e($stockClass); ?>"><?php echo e($barang->stok_status); ?></span></td><td class="px-4 py-3"><?php if (isset($component)) { $__componentOriginal5691c56bcfc63ede7f3e8ced7f54a980 = $component; } ?>
...
<?php /**PATH D:\ProjectPDAM\laragon-6.0-minimal\www\MasterData_REBUILT_CLEAN_FIXED\MasterData\resources\views/components/master/barang/table.blade.php ENDPATH**/ ?>