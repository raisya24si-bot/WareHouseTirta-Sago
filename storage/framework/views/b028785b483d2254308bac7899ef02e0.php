        ...
        <div class="relative">
            ...
            >
                ...
                <div class="px-4 py-2.5 text-center border-t border-outline-variant">
                    <a href="<?php echo e(route('barang.index')); ?>" class="text-xs font-label-bold text-primary hover:underline">
                        Lihat Master Barang
                    </a>
                </div>
            </div>
...
</script><?php /**PATH D:\ProjectPDAM\laragon-6.0-minimal\www\MasterData\resources\views/components/layout/navbar.blade.php ENDPATH**/ ?>