    ...
    <div class="relative w-full max-w-lg rounded-xl bg-white shadow-2xl">
        ...
        <form method="POST" action="<?php echo e(route('opname.add-item', $opname)); ?>" class="space-y-4 p-6">
            ...
            <div>
                ...
                <select name="fk_lokasi" required class="w-full rounded-md border border-outline-variant px-3 py-2">
...
<?php /**PATH D:\ProjectPDAM\laragon-6.0-minimal\www\MasterData (1)\resources\views/components/opname/add-item-modal.blade.php ENDPATH**/ ?>