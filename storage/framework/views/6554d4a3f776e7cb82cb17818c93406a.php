    ...
    <nav class="flex-1 overflow-y-auto px-2 space-y-5 custom-scrollbar">
        ...
        <div>
            ...
            <div class="mx-2">
                ...
                <button
                    ...
                    <span
                        id="master-chevron"
                        class="material-symbols-outlined text-[20px] transition-transform duration-200 <?php echo e($isMasterActive ? 'rotate-180' : ''); ?>">
                        expand_more
                    </span>
                </button>
                ...
                <div
                    id="master-menu"
                    class="ml-4 mt-1 space-y-0.5 border-l-2 border-outline-variant pl-2 overflow-hidden transition-all duration-200 <?php echo e($isMasterActive ? '' : 'hidden'); ?>">

                    <a href="<?php echo e(route('barang.index')); ?>"
                    class="<?php echo e(request()->routeIs('barang.*')
                        ...
                        <span class="material-symbols-outlined mr-3 text-[19px]" <?php if(request()->routeIs('barang.*')): ?> style="font-variation-settings: 'FILL' 1;" <?php endif; ?>>
                            inventory_2
                        </span>
                    ...
                    <a href="<?php echo e(route('master-supplier.index')); ?>"
                    class="<?php echo e(request()->routeIs('master-supplier.*')
                            ? 'bg-primary text-on-primary shadow-sm shadow-primary/30'
                            : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-low'); ?>

                            flex items-center px-4 py-2.5 rounded-lg transition-all duration-150">

                        <span class="material-symbols-outlined mr-3 text-[19px]" <?php if(request()->routeIs('master-supplier.*')): ?> style="font-variation-settings: 'FILL' 1;" <?php endif; ?>>
                            local_shipping
                        </span>
                    ...
                    class="<?php echo e(request()->routeIs('master-kategori.*')
                            ? 'bg-primary text-on-primary shadow-sm shadow-primary/30'
                            : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-low'); ?>

                            flex items-center px-4 py-2.5 rounded-lg transition-all duration-150">

                        <span class="material-symbols-outlined mr-3 text-[19px]" <?php if(request()->routeIs('master-kategori.*')): ?> style="font-variation-settings: 'FILL' 1;" <?php endif; ?>>
                            category
                        </span>
                    ...
                    <a href="<?php echo e(route('master-satuan.index')); ?>"
                    class="<?php echo e(request()->routeIs('master-satuan.*')
                            ? 'bg-primary text-on-primary shadow-sm shadow-primary/30'
                            : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-low'); ?>

                            flex items-center px-4 py-2.5 rounded-lg transition-all duration-150">

                        <span class="material-symbols-outlined mr-3 text-[19px]" <?php if(request()->routeIs('master-satuan.*')): ?> style="font-variation-settings: 'FILL' 1;" <?php endif; ?>>
                            straighten
                        </span>
                    ...
                    <a href="<?php echo e(route('master-gudang.index')); ?>"
                    class="<?php echo e(request()->routeIs('master-gudang.*')
                            ? 'bg-primary text-on-primary shadow-sm shadow-primary/30'
                            : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-low'); ?>

                            flex items-center px-4 py-2.5 rounded-lg transition-all duration-150">

                        <span class="material-symbols-outlined mr-3 text-[19px]" <?php if(request()->routeIs('master-gudang.*')): ?> style="font-variation-settings: 'FILL' 1;" <?php endif; ?>>
                            warehouse
                        </span>
        ...
        <div>
            ...
            <div class="space-y-0.5">
                ...
                <a href="<?php echo e(route('opname.index')); ?>"
                class="<?php echo e(request()->routeIs('opname.*')
                        ? 'bg-primary text-on-primary shadow-sm shadow-primary/30'
                        : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-low'); ?>

                        mx-2 flex items-center px-4 py-2.5 rounded-xl transition-all duration-150 group <?php echo e(request()->routeIs('opname.*') ? '' : 'hover:pl-5'); ?>">

                    <span class="material-symbols-outlined mr-3 text-[20px] <?php echo e(request()->routeIs('opname.*') ? '' : 'text-outline group-hover:text-primary transition-colors'); ?>" <?php if(request()->routeIs('opname.*')): ?> style="font-variation-settings: 'FILL' 1;" <?php endif; ?>>
                        fact_check
                    </span>
                ...
                <a
                    ...
                    class="<?php echo e(request()->routeIs('manajemen-stok.*')
                        ? 'bg-primary text-on-primary shadow-sm shadow-primary/30'
                        : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-low'); ?>

                        mx-2 flex items-center px-4 py-2.5 rounded-xl transition-all duration-150 group <?php echo e(request()->routeIs('manajemen-stok.*') ? '' : 'hover:pl-5'); ?>"
                >
                    <span class="material-symbols-outlined mr-3 text-[20px] <?php echo e(request()->routeIs('manajemen-stok.*') ? '' : 'text-outline group-hover:text-primary transition-colors'); ?>" <?php if(request()->routeIs('manajemen-stok.*')): ?> style="font-variation-settings: 'FILL' 1;" <?php endif; ?>>
                        inventory
                    </span>
                ...
                <a
                    ...
                    class="<?php echo e(request()->routeIs('procurement.*')
                        ...
                        mx-2 flex items-center px-4 py-2.5 rounded-xl transition-all duration-150 group <?php echo e(request()->routeIs('procurement.*') ? '' : 'hover:pl-5'); ?>"
                >
                    <span class="material-symbols-outlined mr-3 text-[20px] <?php echo e(request()->routeIs('procurement.*') ? '' : 'text-outline group-hover:text-primary transition-colors'); ?>" <?php if(request()->routeIs('procurement.*')): ?> style="font-variation-settings: 'FILL' 1;" <?php endif; ?>>
                        shopping_cart
                    </span>
                  ...
                  <a
                    ...
                    class="<?php echo e(request()->routeIs('penerimaan.*') && ! request()->routeIs('penerimaan.approval.*')
                        ...
                        mx-2 flex items-center px-4 py-2.5 rounded-xl transition-all duration-150 group <?php echo e(request()->routeIs('penerimaan.*') ? '' : 'hover:pl-5'); ?>"
                >
                    <span class="material-symbols-outlined mr-3 text-[20px] <?php echo e(request()->routeIs('penerimaan.*') ? '' : 'text-outline group-hover:text-primary transition-colors'); ?>" <?php if(request()->routeIs('penerimaan.*')): ?> style="font-variation-settings: 'FILL' 1;" <?php endif; ?>>
                        move_to_inbox
                    </span>
                ...
                <a
                    ...
                    class="<?php echo e(request()->routeIs('retur.*')
                        ...
                        mx-2 flex items-center px-4 py-2.5 rounded-xl transition-all duration-150 group <?php echo e(request()->routeIs('retur.*') ? '' : 'hover:pl-5'); ?>"
                >
                    <span class="material-symbols-outlined mr-3 text-[20px] <?php echo e(request()->routeIs('retur.*') ? '' : 'text-outline group-hover:text-primary transition-colors'); ?>" <?php if(request()->routeIs('retur.*')): ?> style="font-variation-settings: 'FILL' 1;" <?php endif; ?>>
                        assignment_return
                    </span>
                ...
                <button
                    ...
                    <span
                        id="approval-chevron"
                        class="material-symbols-outlined text-[20px] transition-transform duration-200 <?php echo e($isApprovalActive ? 'rotate-180' : ''); ?>">
                        expand_more
                    </span>
                </button>
    ...
    <div class="px-4 mt-4 pt-4 border-t border-outline-variant">
        ...
        <div class="space-y-0.5">
            ...
            <a href="<?php echo e(route('settings.show')); ?>"
               class="<?php echo e(request()->routeIs('settings.*') ? 'text-primary bg-primary/5' : 'text-on-surface-variant hover:text-primary hover:bg-surface-container-low'); ?> mx-2 flex items-center px-3 py-2 rounded-lg transition-all duration-150 group">

                <span class="material-symbols-outlined mr-3 text-[20px] transition-colors <?php echo e(request()->routeIs('settings.*') ? 'text-primary' : 'text-outline group-hover:text-primary'); ?>">
                    settings
                </span>
        ...
        >
            ...
            <img
                ...
                alt="<?php echo e($sidebarUser->name); ?>"
                src="<?php echo e($sidebarAvatar); ?>"
            >

            <div class="flex-1 overflow-hidden">
                <p class="text-sm font-label-bold text-on-surface truncate">
                    <?php echo e($sidebarUser->name); ?>

                </p>

                <p class="text-xs text-on-surface-variant truncate">
                    <?php echo e($sidebarUser->email); ?>
...
</aside><?php /**PATH D:\ProjectPDAM\laragon-6.0-minimal\www\WareHouse\resources\views/components/layout/sidebar.blade.php ENDPATH**/ ?>