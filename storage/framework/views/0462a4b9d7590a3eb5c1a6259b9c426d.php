...
<?php if($po->isRejected()): ?>
    ...
    <div class="mb-6 rounded-lg border border-red-200 bg-red-50 p-4">
        ...
        <div class="flex items-center gap-2 text-red-700">
            ...
            <p class="font-bold">
                Purchase Order ini ditolak oleh <?php echo e($po->reject_level ? ucfirst(strtolower($po->reject_level)) : 'approver'); ?>
        ...
        <p class="mt-2 rounded-md bg-white/60 p-3 text-sm text-red-700">
            <?php echo e($po->reject_note ?: 'Tidak ada catatan.'); ?>

        </p>

        <p class="mt-2 text-xs text-red-600">
            Silakan revisi Purchase Order ini lalu ajukan ulang lewat tombol "Submit for Approval" di sebelah kanan.
        </p>
...
<?php endif; ?>
        ...
        <div class="rounded-xl border border-outline-variant bg-surface-container-lowest p-5 shadow-sm">
            ...
            <p class="mb-4 text-sm text-on-surface-variant">
                Simpan perubahan barang/deskripsi dulu di atas, baru ajukan Purchase Order ini ke Kasubag.
            </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ProjectPDAM\laragon-6.0-minimal\www\WareHouse\resources\views/procurement/edit.blade.php ENDPATH**/ ?>