...
<div><label class="mb-1 block font-semibold">Jumlah Rak *</label><input id="rak-jumlah" type="number" name="jumlah" min="1" max="50" value="1" required class="w-full rounded-md border border-outline-variant px-3 py-2"><p class="mt-1 text-xs text-on-surface-variant">Kode dibuat otomatis & berurutan, lanjut dari nomor terakhir di gudang ini.</p></div>
</div>
...
<?php /**PATH D:\ProjectPDAM\laragon-6.0-minimal\www\MasterData (1)\resources\views/components/master/gudang/rak-modal.blade.php ENDPATH**/ ?>